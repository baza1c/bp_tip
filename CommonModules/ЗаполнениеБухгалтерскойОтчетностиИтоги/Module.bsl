...
// Возвращает данные с бухгалтерскими итогами по счетам учета Расчеты по аренде,
...
//     * Краткосрочное - Число
//
Функция РазделенноеСальдоСчетовУчетаРасчетыПоАренде(КонецПериода, Организация) Экспорт
	...
	ИсходныеДанные = РасчетПоказателейБалансаПоАренднымОбязательствам.ИсходныеДанныеПоАренднымОбязательствам(Контекст);
