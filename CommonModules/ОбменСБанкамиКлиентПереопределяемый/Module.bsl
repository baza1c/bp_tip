...
//
// Параметры:
//  Результат - Соответствие - Ключ - СправочникСсылка.Пользователи - получатель уведомлений,
//              Значение - Структура - см. ОбменСБанкамиСлужебныйВызовСервера.УведомлениеООтлоненныхДокументах.
//
