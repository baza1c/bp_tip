...
Процедура ПроверитьАдрес(АдресДоставки, АдресДоставкиЗначение) Экспорт
	...
	АдресДоставкиЗначение = ПустойАдрес();
КонецПроцедуры

Функция ПустойАдрес() Экспорт
	ПустойАдрес = УправлениеКонтактнойИнформациейКлиентСервер.СтруктураКонтактнойИнформацииПоТипу(Перечисления.ТипыКонтактнойИнформации.Адрес);
	Возврат УправлениеКонтактнойИнформацией.КонтактнаяИнформацияВJSON(ПустойАдрес, Перечисления.ТипыКонтактнойИнформации.Адрес);
КонецФункции
