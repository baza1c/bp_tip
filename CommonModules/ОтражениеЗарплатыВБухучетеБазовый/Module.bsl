...
Процедура СоздатьВТБухучетНачисленийБезДоговоровГПХ(Организация, ПериодРегистрации, МенеджерВременныхТаблиц)
	...
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(СведенияОБухучетеНачисленийПервичныхДокументов.СпособОтраженияЗарплатыВБухучете, ЗНАЧЕНИЕ(Справочник.СпособыОтраженияЗарплатыВБухУчете.ПустаяСсылка)) = ЗНАЧЕНИЕ(Справочник.СпособыОтраженияЗарплатыВБухУчете.ПустаяСсылка)
	|			ТОГДА СведенияОБухучетеНачисленийСотрудников.СпособОтраженияЗарплатыВБухучете
	|		ИНАЧЕ СведенияОБухучетеНачисленийПервичныхДокументов.СпособОтраженияЗарплатыВБухучете
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТНачисленияПоДокументамДляБухучета КАК СведенияОБухучетеНачисленийПервичныхДокументов
	|		ПО Начисления.ДокументОснование = СведенияОБухучетеНачисленийПервичныхДокументов.ДокументОснование
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
Процедура СоздатьВТНастройкиБухучетаПервичныхДокументов(МенеджерВТ, ИмяИсходнойВТ)
	...
	|			ТОГДА ЗНАЧЕНИЕ(Справочник.СпособыОтраженияЗарплатыВБухУчете.ПустаяСсылка)
	|		ИНАЧЕ ДокументПремия.СпособОтраженияЗарплатыВБухучете
	|	КОНЕЦ КАК СпособОтраженияЗарплатыВБухучете,
	|	ВЫБОР
	|		КОГДА ДокументПремия.Ссылка ЕСТЬ NULL
