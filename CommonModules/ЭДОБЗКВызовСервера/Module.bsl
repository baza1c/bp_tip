...
Функция СвойстваВыводимогоФайла(ДокументЭДОБЗК)
	...
	СвойстваФайла.Вставить("ВидДокумента", ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументЭДОБЗК, "ВидДокумента"));
	СвойстваФайла.Вставить("ВариантПодписания", ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СвойстваФайла.ВидДокумента, "ВариантПодписания"));
