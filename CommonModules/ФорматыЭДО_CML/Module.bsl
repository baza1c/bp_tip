...
Процедура ПрочитатьДанныеПоРасчетнымСчетамКонтрагентаCML(
	...
	Если Не ТипЗнч(НаборДанных) = Тип("СписокXDTO") Тогда
		Если ТипЗнч(НаборДанных) = Тип("ОбъектXDTO") Тогда
			НаборДанных = Новый Массив;
			НаборДанных.Добавить(РасчетныеСчетаXDTO.РасчетныйСчет);
		Иначе
			Возврат;
		КонецЕсли;
	КонецЕсли;
	...
	Для Каждого РасчетныйСчетXDTO Из НаборДанных Цикл
		...
		РеквизитыБанка.Вставить("Наименование", РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "Банк.Наименование"));
		РеквизитыБанка.Вставить("КоррСчет",     РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "Банк.СчетКорреспондентский"));
		РеквизитыБанка.Вставить("SWIFT",        РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "Банк.SWIFT"));
		...
		Если СвойствоЭД <> Неопределено И РасчетныйСчетXDTO.БанкКорреспондент <> Неопределено Тогда
			...
			РеквизитыБанкаКорреспондента = Новый Структура;
			РеквизитыБанкаКорреспондента.Вставить("Код",          РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "БанкКорреспондент.БИК"));
			РеквизитыБанкаКорреспондента.Вставить("Наименование", РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "БанкКорреспондент.Наименование"));
			РеквизитыБанкаКорреспондента.Вставить("КоррСчет",     РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "БанкКорреспондент.СчетКорреспондентский"));
			РеквизитыБанкаКорреспондента.Вставить("SWIFT",        РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "БанкКорреспондент.SWIFT"));
		...
		// Обработка самого счета	
		РеквизитыБанковскогоСчета = Новый Структура;
		РеквизитыБанковскогоСчета.Вставить("НомерСчета", РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "НомерСчета"));
		РеквизитыБанковскогоСчета.Вставить("Комментарий", РаботаСФайламиБЭД.ЗначениеСвойстваXDTO(РасчетныйСчетXDTO, "Комментарий"));
