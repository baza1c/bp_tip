...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ЭтоНовый() Тогда
		...
		РеквизитыОбъекта = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Ссылка, "ПометкаУдаления, КПП");
		
		// Изменяем пометку удаления у контактных лиц, в случае если изменилась пометка у справочника "Контрагенты"
		ПредыдущаяПометкаНаУдаление = РеквизитыОбъекта.ПометкаУдаления;
		...
		Если РеквизитыОбъекта.КПП <> КПП Тогда
			ДополнительныеСвойства.Вставить("ОбновитьРегистрациюВБизнесСети", Истина);
		КонецЕсли;
