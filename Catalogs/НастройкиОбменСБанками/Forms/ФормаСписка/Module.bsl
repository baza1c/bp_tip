...
Процедура ПослеВыбораФайлаНастроекОбмена(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Если ВыбранныеФайлы <> Неопределено Тогда
		...
		ПолноеИмяФайлаНастроек = ВыбранныеФайлы.Имя;
		ЗапуститьПомощникПодключения(АдресФайлаНастроек, ПолноеИмяФайлаНастроек);
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Процедура ЗапуститьПомощникПодключения(АдресФайлаНастроек, ПолноеИмяФайлаНастроек)

	ПараметрыФормы = Новый Структура("АдресДанныхФайлаНастроек, ПолноеИмяФайлаНастроек, ЛокальныйФайл",
		АдресФайлаНастроек, ПолноеИмяФайлаНастроек, Истина);
	ОткрытьФорму("Справочник.НастройкиОбменСБанками.Форма.ПомощникСозданияНастройкиОбмена", ПараметрыФормы);
